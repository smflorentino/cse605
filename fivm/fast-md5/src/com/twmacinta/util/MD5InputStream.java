...
// Modified by FP, Mar 2010: removed default MD5 and native lib support from test
...
public class MD5InputStream extends FilterInputStream {
  ...
  public static void main(String[] arg) {
    try {
      ...
      ////////////////////////////////////////////////////////////////
      //
      // usage:  java com.twmacinta.util.MD5InputStream filename
      //
      /////////
      ...
      if (arg.length<1) {
        System.err.println("Usage: MD5InputStream <filename> [<filename> ...]");
        System.exit(1);
      }
