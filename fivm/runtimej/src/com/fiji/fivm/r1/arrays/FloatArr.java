...
@Unboxed
public final class FloatArr implements Cloneable, java.io.Serializable {
    private FloatArr() {}
    
    public Object fiji_cloneHelper() {
        return ArrayHelper.fastUnsafeArrayClone((float[])Magic.id(this));
    }
    
    public void fiji_gateCopyTo(Pointer ts,
                                Pointer object,
                                Gate gate) {
        float[] self=(float[])Magic.id(this);
