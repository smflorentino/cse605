...
public class SimpleRTSJBaehTest {
	...
	public void run() {
	    ...
	    BoundAsyncEventHandler handler = new BoundAsyncEventHandler(null,
									null,
									null,
									null,
									null,
	    ...
	    if(!success)
		Fail.abort("IllegalThreadStateException not thrown.");
	    ...
	    if(logic.getCount() != 1)
		Fail.abort("Simple Handler did not fire once");
	    ...
	    handler = new BoundAsyncEventHandler(null,
						 null,
						 null,
						 null,
						 null,
	    ...
	    handler = new BoundAsyncEventHandler(new PriorityParameters(10), 
						 null,
						 null,
						 null,
						 null,
	    ...
	    handler = new BoundAsyncEventHandler(new PriorityParameters(255), 
						 null,
						 null,
						 null,
						 null,
