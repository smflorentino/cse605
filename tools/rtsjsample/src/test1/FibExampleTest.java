...
//            System.out.println("IN HEAP:" + (MemoryAreas.getCurrentArea() == MemoryAreas.getHeapArea()));
//            MemoryAreas.setCurrentArea(MemoryAreas.getHeapArea());
////            MemoryAreas.enter(MemoryAreas.getHeapArea(), new Runnable() {
////                public void run() {
////                    System.out.println("Hello from da heap!");
////                }
////            });
