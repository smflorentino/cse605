            ...
            new ClassReader(bytecode).accept(
                new EmptyVisitor() {
                    public void visit(int version,
                        ...
                        stringLength[0]+=name.byteLength();
                        if (signature!=null) {
                            stringLength[0]+=signature.byteLength();
                        }
                        if (superName!=null) {
                            stringLength[0]+=superName.byteLength();
                        }
                        for (UTF8Sequence interfase : interfaces) {
                            stringLength[0]+=interfase.byteLength();
                        }
                    }
                    public void visitSource(UTF8Sequence source,
                                            UTF8Sequence debug) {
                        if (source!=null) {
                            stringLength[0]+=source.byteLength();
                        }
                    }
                    public AnnotationVisitor visitAnnotation(UTF8Sequence desc,
                                                             boolean visible) {
                        if (desc!=null) {
                            stringLength[0]+=desc.byteLength();
                        }
                        return null;
                    }
                    ...
                    public MethodVisitor visitMethod(int access,
                        ...
                        return new EmptyVisitor() {
                            ...
                            public void visitFieldInsn(int opcode,
                                                       ...
                                                       UTF8Sequence name,
                                                       UTF8Sequence desc) {
                                stringLength[0]+=owner.byteLength();
                                stringLength[0]+=name.byteLength();
                                stringLength[0]+=desc.byteLength();
                            }
                            ...
                            public void visitLdcInsn(Object cst) {
                                if (cst instanceof String) {
                                    stringLength[0]+=UTF8String.encode(((String)cst)).length;
                                } else if (cst instanceof com.fiji.asm.Type) {
                                    stringLength[0]+=UTF8String.encode(
                            ...
                            public void visitTryCatchBlock(Label start,
                                                           ...
                                                           UTF8Sequence type) {
                                if (type!=null) {
                                    stringLength[0]+=type.byteLength();
                                }
                            }
