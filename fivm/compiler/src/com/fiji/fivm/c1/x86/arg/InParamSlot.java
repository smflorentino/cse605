...
/** abstract notion of offset into parameter slot for arguments passed to this
 * code block.  corresponds to a positive offset, where 0 is the first argument. */
public class InParamSlot extends LArgBase {
    int offset;
    
    public InParamSlot(int offset) {
        this.offset=offset;
    }
    ...
    public String toString() {
        return ""+offset+"(inParams)";
    }
    
    public String asm(LType useType,LType memType) {
        throw new CompilerException("Cannot generate asm for "+this);
    }
    ...
    public boolean equals(Object other_) {
        ...
        if (!(other_ instanceof InParamSlot)) return false;
        InParamSlot other=(InParamSlot)other_;
        return offset==other.offset;
    }
    
    public LArg offset(int offset) {
        return new InParamSlot(this.offset+offset);
    }
