...
public class FloatConst extends Arg.Const {
    float value;
    ...
    public static FloatConst make(float value) {
        return new FloatConst(value);
    }
    
    public FloatConst negate() {
        return make(-value);
    }
    ...
    public Exectype type() { return Exectype.FLOAT; }
    
    public String toString() { return "(float)"+value; }
    
    public boolean equals(int value) {
        if (true) { // this NEEDS to stay unless other changes are made elsewhere
            return false;
        }
