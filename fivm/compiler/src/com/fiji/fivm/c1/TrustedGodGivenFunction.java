...
// FIXME: shouldn't I have a repository for these?

public class TrustedGodGivenFunction extends Function {
    
    public TrustedGodGivenFunction(String name,NativeSignature sig) {
	super(name,sig);
    }
    
    public TrustedGodGivenFunction(String name,Basetype result,Basetype[] params) {
    ...
    public TrustedGodGivenFunction(String name,Basetype result,Basetype[] params,Callable other) {
