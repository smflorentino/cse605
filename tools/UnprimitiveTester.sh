...
HARDRTJSRC=/home/mihir/repos/cse605/tools/rtsjsample/src
...
fivmc --jobs 4 --g-scoped-memory -o UnmanagedPrimitivesTest src/build/common/*.class src/build/benchmarks/*.class  -m benchmarks/UnmanagedPrimitivesTest
echo "Done!"
