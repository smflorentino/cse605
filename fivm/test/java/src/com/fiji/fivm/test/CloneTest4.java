...
public class CloneTest4 {
    static class C implements Cloneable {
        ...
        public C(int a,int b,int c,String d,int e,int f,int g) {
            this.a=a;
            this.b=b;
            this.c=c;
            this.d=d;
    ...
    public static void main(String[] v) throws Throwable {
        C o1=new C(Integer.parseInt(v[0]),Integer.parseInt(v[1]),Integer.parseInt(v[2]),v[3],Integer.parseInt(v[4]),Integer.parseInt(v[5]),Integer.parseInt(v[6]));
