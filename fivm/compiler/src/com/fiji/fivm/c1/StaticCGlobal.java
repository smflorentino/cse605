...
public class StaticCGlobal extends CGlobal {
    
    public StaticCGlobal(Basetype type,String name,Object value) {
    ...
    public void generateAsm(PrintWriter w) {
        w.println("\t.align "+type.bytes);
        w.println("FIVMR_SYMBOL("+name+"):");
        w.print(Util.asmConstant(type,value));
    }
    
    public long fiatToLong() {
        return Util.fiatToLong(type,value);
    }
}
